  ...
  return (
    <div className="space-y-6">
      {newKey && (
        <Card className="bg-yellow-50 border-yellow-200">
          <div className="flex justify-between items-start">
            <div>
              <h3 className="text-lg font-medium text-yellow-900 mb-2">API Key Created</h3>
              <p className="text-sm text-yellow-800 mb-4">
                Copy this key now. You won&apos;t be able to see it again.
              </p>
              <div className="bg-gray-800 p-4 rounded border border-yellow-300">
      ...
      <Card>
        ...
        {showCreateForm && (
          <form onSubmit={handleCreate} className="mb-6 p-4 bg-gray-900 rounded-lg">
            <div className="mb-4">
