...
export function CreateBrandForm() {
  ...
  return (
    <Card>
      <h2 className="text-xl font-medium mb-4">Create Your First Brand</h2>
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <input
            ...
            pattern="^[a-z0-9-]+$"
            required
            className="w-full px-4 py-2 border border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent font-mono text-sm"
          />
